...
export const Test = () => {
  ...
  return (
    <div
  className="block max-w-md rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-blue-400">
  <form onSubmit={handleSubmit}>
    <div className="grid grid-cols-2 gap-4">
      ...
      <div
        ...
        <p>Above checkbox is {userInput.isChecked ? "checked" : "un-checked"}.</p>
      </div>
      <button
        type="submit"

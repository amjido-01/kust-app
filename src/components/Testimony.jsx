...
export const Testimony = ({ name, dept, img }) => {
    return (
        <div className='inline-block max-w-[20rem] h-[100%] py-4 px-4 bg-[#eeeeee] rounded-md'>
            <div>
                <p className='mt-2 text-[13px] text-center text-[#000000]'>“Lorem ipsum dolor sit amet consectetur. Dictum nunc mattis nisl eget sit in habitasse est amet. Eleifend et diam magna posuere lacus viverra tortor. ”</p>
            </div>

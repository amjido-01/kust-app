            ...
            <div className="md:flex md:justify-between mt-20">
              <div className="flex foot mx-auto justify-between w-full md:w-[80%]">
                <div>
                  ...
                  <ul className=" font-medium text-[#F5F5F5] text-[12px] uppercase">
                    <li className="">
                ...
                <div className="border-2">
                  ...
                  <ul className="text-gray-600 dark:text-gray-400">
                    <li className="flex border-2 items-center">
                      <a
                        href="#"
                        className="text-gray-500 pr-4 hover:text-gray-900 dark:hover:text-white"
                      >
                        <svg
                          className="w-5 h-5"
                          fill="currentColor"
                    ...
                    <li className="flex items-center">
                      <a
                        href="#"
                        className="text-gray-500 pr-2 hover:text-gray-900 dark:hover:text-white"
                      >
                        <svg
                          className="w-5 h-5"
                          fill="currentColor"
                      ...
                      <a href="#" className="hover:underline">
                        itx_prof_niimatullahi/ amjido_01
                      </a>
                    </li>
                  </ul>
                </div>
